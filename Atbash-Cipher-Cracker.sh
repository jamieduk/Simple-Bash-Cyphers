...
# (c) J~Net 2024
#
# ./Atbash-Cipher-Cracker.sh "gvcg sviv"
#
# Atbash Cipher Cracker - Reverses the Atbash cipher transformation

# Function to apply the Atbash cipher (same as encryption)
atbash_cipher() {
  local input="$1"
  local output=""
